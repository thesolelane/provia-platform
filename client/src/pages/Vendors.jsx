        ...
        {loading && vendors.length === 0 ? (
          ...
          <div style={{ padding: 48, textAlign: 'center', color: '#888' }}>
            ...
            <div style={{ fontSize: 13 }}>
              Add the companies you work with to keep their contact info handy.
            </div>
          </div>
        ) : (
          <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: '11px 14px', fontSize: 12, color: '#555' }}>
                        {v.trade || <span style={{ color: '#bbb' }}>—</span>}
                      </td>
                      <td style={{ padding: '11px 14px', fontSize: 12, color: '#555' }}>
                        {v.phone ? (
                          <a
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        {v.trade && (
                          <div style={{ fontSize: 12, color: '#888', marginTop: 2 }}>{v.trade}</div>
                        )}
                      </div>
                      <span
                        style={{
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                ...
                <input
                  {...field('trade')}
                  placeholder="Roofing, Electrical, Lumber..."
                  style={inputStyle}
                />
              </div>
