      ...
      >
        <div>
          ...
          <p style={{ color: '#888', fontSize: 13, marginTop: 4 }}>
            Only these emails and WhatsApp numbers can trigger the bot
          </p>
        </div>
        <button
          ...
          <thead>
            <tr style={{ background: BLUE }}>
              {['Name', 'Identifier', 'Type', 'Role', 'Language', 'Status', ''].map((h) => (
                <th
                  key={h}
                  style={{ padding: '12px 16px', color: 'white', textAlign: 'left', fontSize: 12 }}
                >
                  {h}
                </th>
              ))}
            ...
            {senders.map((s, i) => (
              ...
              >
                ...
                <td style={{ padding: '12px 16px', fontSize: 12 }}>
                  {s.language === 'pt-BR' ? '🇧🇷 PT-BR' : '🇺🇸 EN'}
                </td>
                <td style={{ padding: '12px 16px' }}>
                  <span
                    style={{ color: s.active ? GREEN : '#ccc', fontWeight: 'bold', fontSize: 12 }}
                  >
